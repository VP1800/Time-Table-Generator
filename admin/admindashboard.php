...
<body>
    ...
    <p class="nav-title">
	<span class="text-bold" style="font-size: 2.8rem; margin-right: 5rem; color: #ffffff;">Hello <?php echo $_SESSION['admin']; ?></span><span class="pull-right">
            <a href="logout.php" style="font-size: 2.8rem;">
                Logout
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav" style="background-color:#000">
                    ...
                    <li>
                        <a href="admindashboard.php?info=teacher_allot"><i class="fa fa-fw fa-wrench"></i>Teacher Allotment</a>
                    </li>
            ...
            <div class="container-fluid">
                ...
                elseif($info=="updatetimetable")
				{
					include('update_timetable.php');
                     ...
                     elseif($info=="teacher_allot")
                     {
                         include('teacher_allot.php');
                          }	 
					}
				else
				{
